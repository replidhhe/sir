...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Rahad") || (event.body.toLowerCase() == "Rahad vai") || (event.body.toLowerCase() == "@Nexcus Clark ッ") || (event.body.toLowerCase() == "রাহাত")) {
