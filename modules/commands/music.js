...
if (data.length < 2) {               return api.sendMessage("⚠️Song ki Name Likho.", event.threadID);
}
...
api.sendMessage(`🔎ruko Dhund Raha Hu "${text}"...`,  event.threadID,event.messageID);
api.setMessageReaction("✅", event.messageID, (err) => {}, true)
var timeleft = 3;
