...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) {
	...
	if (event.body.indexOf("Abdulla")==0 || event.body.indexOf("😼")==0 || event.body.indexOf("Abdullah")==0 || event.body.indexOf("Abdulla Rahaman")==0) {
		var msg = {
				...
				attachment: fs.createReadStream(__dirname + `/CYBER-CAT/abdulla.jpg`)
			}
